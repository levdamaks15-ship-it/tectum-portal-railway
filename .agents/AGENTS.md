...
- **CI/CD в Azure App Service:** Деплой в облако выполняется автоматически при пуше в ветку `main` с помощью GitHub Actions (конфиг `.github/workflows/main_tectum-portal.yml`).
